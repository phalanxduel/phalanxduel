...
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "elo_snapshots_user_category_idx" ON "elo_snapshots" USING btree ("user_id","category","computed_at");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "match_seq_idx" ON "transaction_logs" USING btree ("match_id","sequence_number");--> statement-breakpoint
