...
4. **Engine State Representation Seam**: Ensuring the `engine` exposes a narrow API (like a `GameProjection`) rather than forcing callers to traverse nested `GameState` properties.
