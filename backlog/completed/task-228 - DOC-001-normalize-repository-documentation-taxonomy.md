...
assignee:
  - '@gemini'
created_date: '2026-04-12 13:06'
updated_date: '2026-04-12 13:23'
labels:
  - docs
  - curation
dependencies: []
...
- **System Synchronization:** Updated server bootstrap links and client-compatibility tests to reflect the new structure.
