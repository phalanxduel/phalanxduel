...
- **Claude Code/Opus 4.6**: Flagged `docs/archive/doc-1 - GLOSSARY.md.md` double `.md` extension as a backlog filename convention issue.
...
- [ ] #3 The double `.md` extension on `docs/archive/doc-1 - GLOSSARY.md.md` is fixed (renamed to `doc-1 - Phalanx Duel Glossary.md` or similar).
- [ ] #4 `docs/gameplay/rules.md` and `README.md` link to the glossary.
<!-- AC:END -->
...
2. Extract key terms from `docs/gameplay/rules.md`, `engine/src/`, and `server/src/`.
3. Draft `docs/GLOSSARY.md` with concise definitions for each term.
4. Fix `docs/archive/doc-1 - GLOSSARY.md.md` filename.
