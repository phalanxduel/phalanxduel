...
references:
  ...
  - docs/archive/retrospectives.md
  - docs/adr/README.md
  - scripts/ci/verify-doc-fsm-consistency.ts
  - docs/archive/PLAN - configurable-grid-bot-status.md
...
- Deleted `TODO.md`, `progress.md`, and `docs/system/DECISIONS.md` after moving the only remaining live context into Backlog docs and adding `docs/adr/README.md` as the canonical decision index.
...
- Moved `.claude/RETROSPECTIVES.md` into `docs/archive/retrospectives.md` and folded the last standalone review archive notice into `docs/review/META_ANALYSIS.md`.

## Verification

<!-- SECTION:VERIFICATION:BEGIN -->
- `pnpm lint:md docs/adr/README.md docs/review/META_ANALYSIS.md docs/archive/PLAN - configurable-grid-bot-status.md docs/archive/PLAN - 2026-03-10 - otel-native-hybrid-plan.md backlog/tasks/task-33.2 - PHX-HARDEN-003 - Retire legacy roadmap and status files.md`
- `pnpm rules:check`
- `pnpm lint:md backlog/completed/docs/PLAN - 2026-02-24 - legacy-roadmap.md docs/archive/retrospectives.md`
<!-- SECTION:VERIFICATION:END -->
- Retargeted live `docs/plans/*` references in active docs and backlog plans to canonical `docs/archive/*` or `backlog/completed/docs/*` paths.
<!-- SECTION:NOTES:END -->
