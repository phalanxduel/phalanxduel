...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 All GitHub Action steps are pinned to full commit SHAs.;Secret rotation script successfully updates Fly.io and GitHub environments.;Environment contract (docs/configuration.md) matches live infrastructure.;GHA audit workflow passes with 100% SHA coverage.
<!-- AC:END -->
