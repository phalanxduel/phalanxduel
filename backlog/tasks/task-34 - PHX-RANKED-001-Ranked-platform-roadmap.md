---
id: TASK-34
title: PHX-RANKED-001 - Ranked platform roadmap
status: In Progress
assignee:
  - '@codex'
...
references:
  ...
  - backlog/tasks/task-18 - PHX-AUTH-001 - Player Accounts.md
  - backlog/tasks/task-19 - PHX-STATS-001 - Basic Tracking.md
  - backlog/tasks/task-20 - PHX-ELO-001 - Rating System.md
  - backlog/tasks/task-21 - PHX-MATCH-001 - Global Matchmaking Queue.md
  - backlog/tasks/task-22 - PHX-LEADER-001 - Global Leaderboard.md
  - backlog/tasks/task-23 - PHX-SEASON-001 - Seasonal Resets.md
  - >-
    backlog/tasks/task-24 - PHX-INFRA-001 - Implement persistent transaction
    logging (from Gordon Report).md
  - backlog/tasks/task-34.1 - PHX-AUDIT-001-State-hash-chain-and-verification.md
  - backlog/tasks/task-34.2 - PHX-DB-001-Database-integration-baseline.md
  - backlog/tasks/task-34.3 - PHX-REPLAY-003-Replay-Viewer.md
priority: medium
---
