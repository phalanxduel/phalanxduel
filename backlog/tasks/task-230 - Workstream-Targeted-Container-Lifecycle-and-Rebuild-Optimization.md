...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 #1 Documentation updated to reflect targeted 'pnpm docker:up <service>' usage.
- [ ] #2 #2 Dashboard UI explicitly recommends targeted service restarts on mismatch.
- [ ] #3 #3 Audit repeated 'verify:allall' run time and identify remaining rebuild bottlenecks.
- [ ] #4 #4 Evaluate 'turborepo' or similar for artifact caching if 'pnpm build' remains > 30s.
<!-- AC:END -->
