...
The repository currently carries documentation across `docs/`, `backlog/docs/`,
`backlog/decisions/`, task records, and historical archives. Without an
...
- `backlog/decisions/` is the canonical home for active architecture and policy
  decisions.
- `backlog/docs/` is the canonical home for active workflow docs, active plans,
