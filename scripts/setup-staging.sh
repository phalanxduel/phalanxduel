...
echo "2. SENTRY_DSN (from Sentry project)"
echo "3. VITE_SENTRY__CLIENT__SENTRY_DSN (usually same as SENTRY_DSN)"
echo "4. SENTRY_AUTH_TOKEN (from Sentry settings)"
echo ""
echo "Run these commands:"
echo ""
echo "  fly secrets set --app $APP DATABASE_URL='postgresql://...'"
echo "  fly secrets set --app $APP SENTRY_DSN='https://...@sentry.io/...'"
echo "  fly secrets set --app $APP VITE_SENTRY__CLIENT__SENTRY_DSN='https://...@sentry.io/...'"
echo "  fly secrets set --app $APP SENTRY_AUTH_TOKEN='sntrys_...'"
echo ""
