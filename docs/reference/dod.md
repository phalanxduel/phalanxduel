...
| --- | --- |
| Gameplay rules and invariants | [`docs/gameplay/rules.md`](docs/gameplay/rules.md) |
...
| Runtime/package boundaries | [`docs/architecture/principles.md`](docs/architecture/principles.md) |
