...
`https://observability.lan.phalanxduel.com` for OpenObserve and
`https://observability.lan.phalanxduel.com/jaeger` for Jaeger. Explicit
`PHALANX_DEMO_O2_URL` and `PHALANX_DEMO_JAEGER_URL` values always win.
