...
| PD-RULE-056 | §16.1.1 | The third occurrence of an exact canonical position terminates the match as a draw. | invariant | E2 | aligned | `engine/src/liveness.ts`<br>`engine/src/turns.ts` | `engine/tests/liveness.test.ts`<br>`engine/tests/mutation-sensitivity.test.ts`<br>`engine/stryker.gameplay.config.json` |
| PD-RULE-057 | §16.1.2 | Fifty completed turns without an irreversible LP HP draw-pile or Graveyard change terminate the match as a draw. | recurrence | E2 | aligned | `engine/src/liveness.ts`<br>`engine/src/turns.ts` | `engine/tests/liveness.test.ts`<br>`engine/tests/mutation-sensitivity.test.ts`<br>`engine/stryker.gameplay.config.json` |
| PD-RULE-058 | §16.1.3 | A still-live match draws after completing turn 200. | inequality | E4 | aligned | `engine/src/liveness.ts`<br>`engine/src/turns.ts` | `engine/tests/liveness.test.ts`<br>`engine/tests/mutation-sensitivity.test.ts`<br>`engine/stryker.gameplay.config.json` |
| PD-RULE-059 | §16.1 | Draws have no winner and simultaneous draw predicates use the declared deterministic precedence. | sequence | E2 | aligned | `shared/src/schema.ts`<br>`engine/src/liveness.ts`<br>`engine/src/turns.ts` | `shared/tests/schema.test.ts`<br>`engine/tests/liveness.test.ts` |
| PD-RULE-060 | §16.1.3 | Every legal competitive v3.0 match reaches gameOver after a finite action sequence. | proof | E4 | aligned | `engine/src/liveness.ts`<br>`engine/src/turns.ts`<br>`engine/src/state-machine.ts` | `engine/tests/property-invariants.test.ts`<br>`engine/tests/property-fastcheck.test.ts`<br>`engine/tests/liveness.test.ts` |
