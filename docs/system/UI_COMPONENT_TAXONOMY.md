...
By conforming to this taxonomy, the active browser client can maintain a complete, authentic, and server-compliant gameplay experience. Godot/V2 source and local archives have been removed; historical parity work is recoverable from `be909aa^:archive/` in Git history and is not an active QA target.
