...
| @secretlint/secretlint-rule-preset-canary | package.json:130:6       | error    |
| lint-staged                               | package.json:146:6       | error    |
| actionlint                                | package.json:135:6       | error    |
| shellcheck                                | package.json:151:6       | error    |
