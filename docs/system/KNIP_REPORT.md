...
| @secretlint/secretlint-rule-preset-canary | package.json:133:6       | error    |
| lint-staged                               | package.json:149:6       | error    |
| actionlint                                | package.json:138:6       | error    |
| shellcheck                                | package.json:154:6       | error    |
