...
| @secretlint/secretlint-rule-preset-canary | package.json:132:6       | error    |
| lint-staged                               | package.json:148:6       | error    |
| actionlint                                | package.json:137:6       | error    |
| shellcheck                                | package.json:153:6       | error    |
