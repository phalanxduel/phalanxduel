...
audience: team
related:
  - docs/archive/doc-6 - Degraded Connectivity Fallback Proposal.md
...
Versioning policy is governed by [docs/architecture/versioning.md](docs/architecture/versioning.md).
...
- external-client compatibility and versioning docs, including
  `docs/reference/client-compatibility.md` and `docs/architecture/versioning.md`
