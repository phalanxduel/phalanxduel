...
> **Terminology:** For definitions of domain-specific terms used throughout this document (e.g., Target Chain, Boundary, Phase, Player Index), see the [Glossary](docs/reference/glossary.md).
